...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AsyncJob.job_type'
        db.add_column('asyncjob_asyncjob', 'job_type',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AsyncJob.job_type'
        db.delete_column('asyncjob_asyncjob', 'job_type')
    ...
    models = {
        'asyncjob.asyncjob': {
            ...
            'job_type': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
